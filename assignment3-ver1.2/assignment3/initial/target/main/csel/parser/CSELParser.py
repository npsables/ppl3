...
class CSELParser ( Parser ):
    ...
    class Var_tempContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitVar_temp" ):
                return visitor.visitVar_temp(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Var_constantContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitVar_constant" ):
                return visitor.visitVar_constant(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Exp_8Context(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitExp_8" ):
                return visitor.visitExp_8(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Forof_stmtContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitForof_stmt" ):
                return visitor.visitForof_stmt(self)
            else:
                return visitor.visitChildren(self)
    ...
    class FuncallsContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitFuncalls" ):
                return visitor.visitFuncalls(self)
            else:
                return visitor.visitChildren(self)
    ...
    class ListkeyvalueContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitListkeyvalue" ):
                return visitor.visitListkeyvalue(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Normal_litContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitNormal_lit" ):
                return visitor.visitNormal_lit(self)
            else:
                return visitor.visitChildren(self)
    ...
    class PrimtypesContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitPrimtypes" ):
                return visitor.visitPrimtypes(self)
            else:
                return visitor.visitChildren(self)
